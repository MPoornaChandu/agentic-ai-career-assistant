  ...
  return (
    <section className="section-shell section-reveal pt-12">
      <div className="mb-10 text-center">
        ...
        <h2 className="section-title mx-auto max-w-3xl">From resume paste to internship plan in minutes.</h2>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-3">
        {steps.map((step, index) => {
          ...
          return (
            <article key={step.title} className="glass-card glass-hover rounded-lg p-6">

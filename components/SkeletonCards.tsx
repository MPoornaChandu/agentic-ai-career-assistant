export default function SkeletonCards() {
  return (
    <div className="mt-8 grid gap-4 md:grid-cols-2 xl:grid-cols-3" aria-label="Loading analysis results">
      {Array.from({ length: 6 }).map((_, index) => (
        <div key={index} className="glass-card rounded-lg p-5">
          ...
          <div className="skeleton animate-shimmer mt-6 h-24 rounded-lg" />
